...
24 名开发集参与者观看了相同的 15 个时间对齐视频。本文首先解决一个预测问题：如何降低新观众观看这些熟悉视频时的总体平均绝对误差（MAE）。低误差群体情绪曲线可望用于预测已知视频的大致反应，为视频剪辑、广告投放或内容推荐提供群体基线，并为新观众预测提供粗略初始化；这些下游用途尚未在本项目中直接验证。
