...
estimate averages predictions from one final checkpoint standardized with
statistics from all 24 development participants and from five
participant-grouped fold checkpoints. Fixed fusion combines this ensemble with
a video--time prior built from all 24 development participants.

After all predictions had been generated, we examined the external labels to
characterize the held-out evaluation domain. Figure~\ref{fig:external-data-landscape}
shows a broad but nonuniform valence--arousal distribution and visible variation
in sample-weighted mean labels across videos and normalized-time bins. This
descriptive analysis does not enter any predictor.
