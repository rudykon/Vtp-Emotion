...
(MAE) of 47.3509, the prior 29.0633, and their fixed fusion 29.0146. A separate
blind evaluation on four subject-disjoint viewers further decomposed the signal:
MAE was 44.3296 for a global constant, 33.3627 for video identity, 28.0410 for
the video--time prior, 42.7486 for physiology, and 27.7246 for fixed fusion.
Thus, video identity and within-video time explain the main gains, while
physiology provides a smaller but directionally consistent residual improvement.
...
when stimuli repeat. Source-explicit baselines and crossed
